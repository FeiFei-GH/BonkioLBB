...
var scale = -1;
var requestAnimationFrameOriginal = window.requestAnimationFrame;
        ...
        if (!this.injectedAPI) { // initialize overriding receive listener (only run once)
            ...
            this.onmessage = function (args) {
                ...
                switch(args.data.substring(0, 5)) {
                    ...
                    case "42[3,": args = receive_RoomJoin(args);
                        break; // *Room Join
                    case "42[4,": args = receive_PlayerJoin(args);
                        break; // *Player Join
                    case "42[5,": args = receive_PlayerLeave(args);
                        break; // *Player Join
                    case "42[6,": args = receive_HostLeave(args);
                        break; // *Host Leave
                    case "42[7,": args = receive_Inputs(args);
                        break; // *Receive Inputs
                    case "42[8,":
                        break; // *Ready Change
                    case "42[13":
                        break; // *Game End
                    case "42[15": args = receive_GameStart(args);
                        break; // *Game Start
                    case "42[16":
                        break; // *Error
                    case "42[18": args = receive_TeamChange(args);
                        break; // *Team Change
                    case "42[19": 
                        break; // *Teamlock Toggle
                    case "42[20": args = receive_ChatMessage(args);
                        break; // *Chat Message
                    case "42[21":
                        break; // *Initial Data
                    case "42[24":
                        break; // *Kicked
                    case "42[26": args = receive_ModeChange(args);
                        break; // *Change Mode
                    case "42[27":
                        break; // *Change Rounds
                    case "42[29": args = receive_MapSwitch(args);
                        break; // *Map Switch
                    case "42[32": 
                        break; // *inactive?
                    case "42[33": 
                    ...
                    case "42[40": 
                        break; // *Save Replay
                    case "42[41": args = receive_NewHost(args);
                        break; // *New Host
                    case "42[42": args = receive_FriendReq(args);
                        break; // *Friend Req
                    case "42[43": 
            ...
            switch(args.substring(0, 5)) {
                case "42[4,": args = send_SendInputs(args);
                    break; // *Send Inputs
                case "42[5,": args = send_TriggerStart(args);
                    break; // *Trigger Start
                case "42[6,": 
                ...
                case "42[12": args = send_CreateRoom(args);
                    break;  // *Create Room
                case "42[14":
                ...
                case "42[23": args = send_MapAdd(args);
                    break;  // *Send Map Add
                case "42[26": 
...
var receive_RoomJoin = function (args) {
...
var receive_PlayerJoin = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_PlayerLeave = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_HostLeave = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_Inputs = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_GameStart = function (args) {
...
var receive_TeamChange = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_ChatMessage = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_ModeChange = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_MapSwitch = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_NewHost = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var receive_FriendReq = function (args) {
    var jsonargs = JSON.parse(args.data.substring(2));
...
var send_TriggerStart = function (args) {
...
var send_CreateRoom = function (args) {
    playerList = [];
...
var send_SendInputs = function (args) {
    //LB_HUD.playerList[myID].lastMoveTime = Date.now();
    return args;
}

var send_MapAdd = function (args) {
