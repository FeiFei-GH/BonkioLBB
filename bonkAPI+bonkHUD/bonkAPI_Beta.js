 ...
 */
    ...
    bonkAPI.onLoaded = () => {
        ...
        bonkAPI.bonkWSS = 0;
        bonkAPI.originalSend = bonkAPI.windowMGF.WebSocket.prototype.send;
        ...
        bonkAPI.ISpsonpair = new bonkAPI.windowMGF.dcodeIO.PSON.StaticPair([
            "physics",
            "shapes",
            "fixtures",
            "bodies",
        ...
        // !----------------------------Overriding bonkWSS----------------------------
        // #region
        bonkAPI.windowMGF.WebSocket.prototype.send = function (args) {
                ...
                if (!this.injectedAPI) {
                    ...
                    switch (args.substring(0, 5)) {
                        ...
                        case "42[23": // *Send Map Add
                            console.log("trying call send function");
    ...
    */
    ...
    bonkAPI.checkDocumentReady = () => {
        if (window == top) {
            // Make sure at top, since tempermonkey runs script at MGF again
